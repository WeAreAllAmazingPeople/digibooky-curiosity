...
class BookServiceImplementationTest {
    ...
    void getBooksByTitle_givenNullKeyword_thenReturnAllBooks() {
         assertEquals(List.of(book1, book2, book3),bookService.getAllBooks(null, "", null));
    }
    @Test
    ...
    void getBooksByTitle_givenKeywordTitle_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1, book2), bookService.getAllBooks("title",null, null));
    }
    @Test
    void getBooksByTitle_givenKeywordFunny_thenReturn1MatchingBooks() {
        assertEquals(List.of(book1), bookService.getAllBooks("funny",null, null));
    }
    @Test
    void getBooksByTitle_givenWilcardKeywordFun_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1,book2), bookService.getAllBooks(".*tit.*",null, null));
    }
    ...
    void getBooksByIsbn_givenBlankSpaceKeyword_thenReturnEmptyList() {
        assertEquals(List.of(), bookService.getAllBooks(null," ",null));
    }
    @Test
    void getBooksByIsbn_givenPartialKeywordIsbn_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1, book2), bookService.getAllBooks(null,"878-3-16-148410",null));
    }
    @Test
    void getBooksByIsbn_givenPartialKeywordIsbn_thenReturn1MatchingBooks() {
        assertEquals(List.of(book3), bookService.getAllBooks(null,"999",null));
    }
    @Test
    void getBooksByIsbn_givenWilcardKeyword16_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1,book2), bookService.getAllBooks(null,".*-16.*",null));
    }
    ...
    void getBooksByAuthor_givenAuthorPartialFirstname_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1, book2), bookService.getAllBooks(null,null,"joh"));
    }
    @Test
    void getBooksByAuthor_givenAuthorPartialLastname_thenReturn1MatchingBooks() {
        assertEquals(List.of(book3), bookService.getAllBooks(null,null,"nit"));
    }

    @Test
    void getBooksByAuthor_givenAuthorFullname_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1, book2), bookService.getAllBooks(null,null,"john doe"));
    }
    @Test
    void getBooksByAuthor_givenWilcardKeywordDo_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1,book2), bookService.getAllBooks(null,null,".*do.*"));
    }

    //mixed search
    @Test
    void getBooksByTitleIsbnAuthor_givenMultiplePartialKeywords_thenReturn2MatchingBooks() {
        assertEquals(List.of(book1,book2), bookService.getAllBooks("ti","878",".*do.*"));
    }
